...
export default class zombieB extends Phaser.Physics.Arcade.Sprite {
    ...
    updateHealthBar() {
      ...
      this.healthBarContainer.fillRect(this.x - 15, this.y - 25, 30 * healthPercentage, 4);
    }
    ...
    update(player, time) {
      ...
      if (distanceToPlayer < chaseDistance) {
        ...
        // Check for attack
        if (distanceToPlayer < 50 && time > this.lastAttackTime + this.attackCooldown) {
    ...
    attackPlayer(player) {
      // Only attack if the player has the takeDamage method
